...
Prototype: `core.ort.Model(clip[] clips, string network_path[, int pad = 0, int block_w = 0, int block_h = 0, string provider = "", int device_id = 0, int verbosity = 2, bint cudnn_benchmark = True, bint builtin = False, string builtindir="models"])`
